...
#define CHECK_CHANNEL(P, I)                                                                                            \
	(CHECK_CHANNEL_BIT(((unsigned int *)(((lp_state_type *)P)->channel_state))[(int)((int)I / BITS)],              \
	    ((int)I % BITS)))
#define SET_CHANNEL(P, I)                                                                                              \
	(SET_CHANNEL_BIT(((unsigned int *)(((lp_state_type *)P)->channel_state))[(int)((int)I / BITS)],                \
	    ((int)I % BITS)))
#define RESET_CHANNEL(P, I)                                                                                            \
	(RESET_CHANNEL_BIT(((unsigned int *)(((lp_state_type *)P)->channel_state))[(int)((int)I / BITS)],              \
	    ((int)I % BITS)))
...
static inline void deallocation(unsigned int me, lp_state_type *pointer, int ch, simtime_t lvt)
{
	channel *c;
