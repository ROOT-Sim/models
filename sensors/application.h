...
enum {
	/*
	 * After the root node (logical process) has parsed the configuration file provided by the user, it broadcasts
	 * this event to all the other nodes to tell them they can finally start
	 */
...
typedef struct _node_state {
	 ...
	 *
	 * An array of elements of pointers to "forwarding_queue_entry" represents the output queue of the node;
	 * pointers refer to packets (actually entries) created by the node or packets (entries) received by other nodes
