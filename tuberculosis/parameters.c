 ...
 * (Contact)
 */
const double p_contacts_age_class[4][3] = {{0.30, 0.95, 1.0}, {0.05, 0.99, 1.00}, {0.12, 0.97, 1.00},
    {0.05, 0.50, 1.00}};

/* Age groups in each age class and probability of each one */
const double p_contacts_age_groups[3][4] = {{0.1970, 0.4091, 0.6970, 1.0000}, {0.2581, 0.6138, 0.8557, 1.0000},
    {0.6667, 0.8788, 1.0000, 1.0000}};
 ...
 * (Contact)
 */
const double p_origin_gender[4][4] = {{0.40, 0.68, 0.87, 1.00}, {0.35, 0.68, 0.84, 1.00}, {0.11, 0.14, 0.79, 1.00},
    {0.08, 0.14, 0.63, 1.00}};
